      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 rounded-2xl border border-rule bg-white/70 p-5">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm">
            ...
            <li>Security Review → security reviewer</li>
            <li>PR Reviewer → PR reviewer</li>
            <li>Architect → Architect Agent</li>
            <li>Research / Tech Debt → their own reports</li>
          </ul>
          <p className="mt-4 text-sm text-ink-soft">
            Until those adapters are connected, each specialist writes a structured artifact from
            the locked analysis so you can see the plan, the gate, and the human stop.
          </p>
        </div>
      </main>
    </div>
